...
function Cursor({ x, y }: CursorProps) {
    return (
        <motion.div
            ...
            animate={{ x, y }}
            transition={{ duration: 1.2, ease: [0.68, -0.55, 0.265, 1.55] }} // Bouncy ease
        >
...
function Flag({ shouldMove, themeMode }: { shouldMove: boolean; themeMode?: string }) {
    return (
        <motion.div
            ...
            transition={{ duration: 0.6, ease: [0.68, -0.55, 0.265, 1.55] }} // Bouncy ease
        >
    ...
    return (
        <motion.div
            ...
            transition={{
                duration,
                ease:
                    phase === "resizing" ? [0.68, -0.55, 0.265, 1.55] : [0.68, -0.55, 0.265, 1.55], // Bouncy ease for all phases
            }}
        >
            ...
            {isVisible && (
                <motion.div
                    ...
                    transition={{
                        ...
                        opacity: { duration: 0.3, ease: [0.68, -0.55, 0.265, 1.55] },
                    }}
                >
                    {/* Main white modal */}
                    <div
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 0.2, ease: [0.68, -0.55, 0.265, 1.55] }} // Bouncy ease
                    >
                        {!showLoading && (
                            <div
                                style={{
...
export default function ModalInteractionBouncy({ isDarkMode }: { isDarkMode?: boolean }) {
