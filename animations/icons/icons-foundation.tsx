                ...
                <div className={`flex-shrink-0 ${styles.svgContainer}`}>
                    ...
                    >
                        ...
                        <g clipPath="url(#clip0_1878_34641)">
                            ...
                            <g className={styles.greenPlayButton}>
                            ...
                            <path
                                className={styles.topHorizontalBar}
                            ...
                            <path
                                className={styles.topMiddleStroke}
                                d="M70 113 L70 107"
                                fill="none"
                                stroke="#101214"
                                strokeWidth="3"
                            ...
                            <path
                                className={styles.bottomHorizontalBar}
                            ...
                            <path
                                className={styles.bottomMiddleStroke}
                                d="M70 27 L70 33"
                                fill="none"
                                stroke="#101214"
                                strokeWidth="3"
