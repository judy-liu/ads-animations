...
export default function IconsMotionAdvanced() {
    return (
                ...
                <div className="flex-shrink-0 cursor-default">
                    ...
                    >
                        ...
                        <g clipPath="url(#clip0_1878_34641)">
                            ...
                            {/* Top horizontal bar - main structure (outer strokes) with repeating animation */}
                            <motion.path
                            ...
                            {/* Top horizontal bar - middle stroke (thinner) with repeating animation */}
                            <motion.path
                                initial={{ pathLength: 0 }}
                                animate={{ pathLength: 1 }}
                                transition={{
                            ...
                            {/* Bottom horizontal bar - main structure (outer strokes) with repeating animation */}
                            <motion.path
                                initial={{ pathLength: 0 }}
                                animate={{ pathLength: 1 }}
                                transition={{
                            ...
                            {/* Bottom horizontal bar - middle stroke (thinner) with repeating animation */}
                            <motion.path
                                initial={{ pathLength: 0 }}
                                animate={{ pathLength: 1 }}
                                transition={{
                            ...
                            {/* Repeating redraw animations for top bar */}
                            <motion.path
                            ...
                            {/* Repeating redraw animations for top middle stroke */}
                            <motion.path
                                initial={{ pathLength: 1 }}
                                animate={{ pathLength: [1, 0, 1] }}
                                transition={{
                            ...
                            {/* Repeating redraw animations for bottom bar */}
                            <motion.path
                                initial={{ pathLength: 1 }}
                                animate={{ pathLength: [1, 0, 1] }}
                                transition={{
                            ...
                            {/* Repeating redraw animations for bottom middle stroke */}
                            <motion.path
                                initial={{ pathLength: 1 }}
                                animate={{ pathLength: [1, 0, 1] }}
                                transition={{
